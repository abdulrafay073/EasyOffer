        ...
        <ul class="navbar-nav navbar-nav-right ml-lg-auto">
            ...
            <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                    ...
                    <img class="nav-profile-img mr-2" src="{{ asset('images/faces/face16.jpg') }}" />
                    <?php } else if (auth()->user()->role_id == 3) { ?>
                    <img class="nav-profile-img mr-2" src="{{ asset('images/faces/face17.jpg') }}" />
                    <?php } else { ?>
                    <img class="nav-profile-img mr-2" src="{{ asset('images/faces/face21.jpg') }}" />
                    <?php } ?>
