 ...
 <nav class="sidebar sidebar-offcanvas" id="sidebar">
     <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
         ...
         <a class="sidebar-brand brand-logo" href="{{ route('buyer-dashboard') }}"><img
                 src="{{ asset('images/logo1.png') }}" alt="logo" /></a>
         <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="{{ route('buyer-dashboard') }}"><img
                 src="{{ asset('images/logo-mini.svg') }}" alt="logo" /></a>
         <?php } else if (auth()->user()->role_id == 3) { ?>
         <a class="sidebar-brand brand-logo" href="{{ route('seller-dashboard') }}"><img
                 src="{{ asset('images/logo1.png') }}" alt="logo" /></a>
         <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="{{ route('seller-dashboard') }}"><img
                 src="{{ asset('images/logo-mini.svg') }}" alt="logo" /></a>
         <?php } else { ?>
         <a class="sidebar-brand brand-logo" href="{{ route('admin-dashboard') }}"><img
                 src="{{ asset('images/logo1.png') }}" alt="logo" /></a>
         <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="{{ route('admin-dashboard') }}"><img
                 src="{{ asset('images/logo-mini.svg') }}" alt="logo" /></a>
         <?php } ?>
     </div>
     <ul class="nav mt-3">
         ...
         <li class="nav-item">
             <a class="nav-link" data-toggle="collapse" href="#ui-finance" aria-expanded="false"
