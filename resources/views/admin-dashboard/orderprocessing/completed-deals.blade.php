    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Completed Deals</li>
            </ol>
        </nav>
    </div>
                        ...
                        <table class="table" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-2">
                                        <a href="{{ route('completed-deals-viewdetail', $item['id']) }}" class="btn text-white btn-rounded" style="background-color:#232475">
                                            View Detail
                                        </a>
                                    </td>
                                </tr>
