                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="px-2">
                                        <a href="{{ route('sample-viewdetail', $item['id']) }}"
                                            class="btn text-white btn-rounded" style="background-color:#00CCCD">
                                            View Detail
                                        </a>

                                        <a href="{{ route('sample-requests-proceed', $item['id']) }}"
                                            class="btn text-white btn-rounded" style="background-color:#237549">
                                            Proceed
                                        </a>

                                        <a hidden href="" class="btn text-white btn-rounded" style="background-color:#232475">
                                            Place Bid
                                        </a>
...
<div class="modal fade" id="rejectModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('sample-requests-reject') }}" method="post">
                {{ csrf_field() }}
