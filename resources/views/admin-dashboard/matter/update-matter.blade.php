    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Update Matter </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body mt-2">
                    ...
                    <form action="{{ route('submit-update-matter') }}" method="POST" class="forms-sample">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="product" value="{{ $data->product_name }}" class="form-control" placeholder="Enter product">
                            </div>

                            <div class="col-md-6 mt-3">
                                <label><b>Problem</b></label>
                                <input type="text" name="problem" value="{{ $data->problem }}" class="form-control" placeholder="Enter problem">
                            </div>

                            <div class="col-md-6 mt-3">
                                <label><b>Problem Rated</b></label>
                                <input type="text" name="problemrated" value="{{ $data->problem_rated }}" class="form-control" placeholder="Enter problem rated">
                            </div>

                            <div class="col-md-6 mt-3">
                                <label><b>Status</b></label>
                                <input type="text" name="status" value="{{ $data->status }}" class="form-control" placeholder="Enter status">
                            </div>

                            <div class="col-md-6 mt-3">
                                <label><b>Solution</b></label>
                                <input type="text" name="solution" value="{{ $data->solution }}" class="form-control" placeholder="Solution">
                            </div>

                            <div class="col-md-12 mt-3">
                                <label><b>Boss Feedback</b></label>
                                <input type="text" name="bossfeedback" value="{{ $data->boss_feedback }}" class="form-control" placeholder="Enter Feedback">
                            </div>

                            <div class="col-md-6 mt-3">
                                <label><b>Manager Approval</b></label>
                                <input type="text" name="managerapproval" value="{{ $data->manager_approval }}" class="form-control" placeholder="Manager approval">
                            </div>

                            <div class="col-md-6 mt-3">
                                <label><b>Resolve Time</b></label>
                                <input type="text" name="resolvetime" value="{{ $data->resolve_time }}" class="form-control" placeholder="Resolve time">
                            </div>
