    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Quotation Requests </li>
            </ol>
        </nav>
    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="px-2">
                                        <a href="{{ route('sale-quotation-viewdetails', $item['id']) }}"
                                            class="btn text-white btn-rounded" style="background-color:#00CCCD">
                                            View Detail
                                        </a>
                                        <a href="{{ route('sale-quotation-viewbids', $item['id']) }}"
