                        ...
                        <table class="table" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>{{ $data['gst'] }}</td>
                                    <td class="px-2">
                                        <form action="{{ route('seller-accept') }}" method="POST"
...
<div class="modal fade" id="rejectModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('seller-reject') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <input name="sellerid" id="reject_sellerid" value="" hidden>
                    <div class="row">
                        <div class="col-md-12">
