                        ...
                        <table class="table" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>{{ $data['gst'] }}</td>
                                    <td class="px-2">
                                        <a href="{{ route('buyer-viewdetail', $data->id) }}"
                                            class="btn text-white btn-rounded" style="background-color:#232475">
                                            View Detail
                                        </a>
                                        <a href="{{ route('buyer-edit', $data->id) }}"
                                            class="btn text-white btn-rounded" style="background-color:#232475">
                                            Edit
                                        </a>
...
<div class="modal fade" id="ratingModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('buyer-rating') }}" method="POST">
                @csrf

                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title"> Buyer Rating</h4>
                    <!-- <button type="button" class="close" data-dismiss="modal">&times;</button> -->
                </div>

                <!-- Modal body -->
                <div class="modal-body">
                    <input name="buyerid" id="rating_buyerid" value="" hidden>
                    <div class="row">
                        <div class="col-md-12">
...
<div class="modal fade" id="removeModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('buyer-remove') }}" method="POST">
                @csrf
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <input name="buyerid" id="remove_buyerid" value="" hidden>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Note</label>
