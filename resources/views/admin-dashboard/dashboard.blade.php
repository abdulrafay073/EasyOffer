                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('images/faces/face13.jpg') }}" alt="image" />
                                            <div class="table-user-name ml-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                        <img class="survey-img mb-lg-3" src="{{ asset('images/dashboard/img_3.jpg') }}" alt="" />
                        <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                        <img class="survey-img mb-lg-3" src="{{ asset('images/dashboard/img_1.jpg') }}" alt="" />
                        <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                        <img class="survey-img mb-lg-3" src="{{ asset('images/dashboard/img_2.jpg') }}" alt="" />
                        <div class="pt-2">
                ...
                <div class="card-body">
                        ...
                        <div class="col-12 col-sm-7">
                            <div class="row">
                                <div class="col-4 col-md-4">
                                    <img class="customer-img" src="{{ asset('images/faces/face22.jpg') }}" alt="" />
                                </div>
                        ...
                        <div class="col-sm-7">
                            <div class="row">
                                <div class="col-4 col-sm-4">
                                    <img class="customer-img" src="{{ asset('images/faces/face25.jpg') }}" alt="" />
                                </div>
                    ...
                    <div class="row py-1">
                        <div class="col-sm-7">
                            <div class="row">
                                <div class="col-4 col-sm-4">
                                    <img class="customer-img" src="{{ asset('images/faces/face15.jpg') }}" alt="" />
                                </div>
                                <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row py-1">
                        <div class="col-sm-7">
                            <div class="row">
                                <div class="col-4 col-sm-4">
                                    <img class="customer-img" src="{{ asset('images/faces/face5.jpg') }}" alt="" />
                                </div>
                                <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="row">
                                <div class="col-4 col-sm-4">
                                    <img class="customer-img" src="{{ asset('images/faces/face2.jpg') }}" alt="" />
                                </div>
                                <div class="col-8 col-sm-8 p-sm-0">
                ...
                <div class="card-body">
                    ...
                    <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                        <div class="col-sm-9 pl-0">
                            <div class="d-flex">
                                <img src="{{ asset('images/dashboard/img_4.jpg') }}" alt="" />
                                <div class="pl-2">
                            ...
                            <p class="text-muted">
                                ...
                                <span class="d-inline-block">
                                    <span class="d-flex d-inline-block">
                                        <img class="ml-1" src="{{ asset('images/faces/face1.jpg') }}" alt="" />
                                        <img class="ml-1" src="{{ asset('images/faces/face10.jpg') }}" alt="" />
                                        <img class="ml-1" src="{{ asset('images/faces/face14.jpg') }}" alt="" />
                                    </span>
                                </span>
                            </p>
                        </li>
                ...
                <div class="card-body">
                    ...
                    <div class="row py-2">
                        <div class="col-sm-12">
                            <div class="d-flex justify-content-between pb-3 border-bottom">
                                <div>
                                    <img class="mr-2" src="{{ asset('images/browser-logo/opera-logo.png') }}" alt="" />
                    ...
                    <div class="row py-2">
                        <div class="col-sm-12">
                            <div class="d-flex justify-content-between pb-3 border-bottom">
                                <div>
                                    <img class="mr-2" src="{{ asset('images/browser-logo/safari-logo.png') }}" alt="" />
                    ...
                    <div class="row py-2">
                        <div class="col-sm-12">
                            <div class="d-flex justify-content-between pb-3 border-bottom">
                                <div>
                                    <img class="mr-2" src="{{ asset('images/browser-logo/chrome-logo.png') }}" alt="" />
...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-lg-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Total Requests System Made</h4>
        ...
        <div class="col-lg-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Total Bids System Made</h4>
        ...
        <div class="col-lg-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Total Rejected Deals</h4>
        ...
        <div class="col-lg-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Total Seller Registered In A System</h4>
        ...
        <div class="col-lg-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Total Buyer Registered In A System</h4>
        ...
        <div class="col-lg-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Total Deals Done Within A System</h4>
